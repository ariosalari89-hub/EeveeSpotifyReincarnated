...
xcrun clang -fobjc-arc -c Tests/LocalAudioNativeArtwork/ViewFixtures.m -o "$QA_DIR/artwork-view-fixtures.o"
xcrun swiftc -swift-version 5 -framework AVFoundation -framework ImageIO \
  ...
  "$QA_DIR/artwork-display-fixtures.o" "$QA_DIR/artwork-view-fixtures.o" \
...
xcrun swiftc -swift-version 5 -parse-as-library -ISources/EeveeSpotifyC/include \
  ...
  "$QA_DIR/artwork-adapter.o" "$QA_DIR/artwork-trace.o" "$QA_DIR/artwork-view-trace.o" "$QA_DIR/artwork-unsupported-fixtures.o" -o "$QA_DIR/native-artwork-unsupported-tests"
