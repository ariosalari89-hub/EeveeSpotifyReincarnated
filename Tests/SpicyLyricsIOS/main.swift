    ...
    func testRendererTransitions(baseline: Bool) async throws {
        ...
        let phases = baseline ? ["inline", "card"]
            : ["inline", "card", "background", "highlight", "card-layout", "background-style", "background-speed", "background-motion-perception", "background-lifecycle",
               "gradient-recovery", "gradient-quality", "gradient-pc-parity", "gradient-artwork-transition", "gradient-context", "shuffle-availability", "shuffle-settlement"] + desktopPhases
        for phase in phases {
